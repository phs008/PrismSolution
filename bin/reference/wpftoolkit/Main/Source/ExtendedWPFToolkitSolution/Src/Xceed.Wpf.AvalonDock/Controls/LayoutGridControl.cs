...
namespace Xceed.Wpf.AvalonDock.Controls
{
    public abstract class LayoutGridControl<T> : Grid, ILayoutControl where T : class, ILayoutPanelElement
    {
        ...
        /// <summary>
        /// TODO : 아발론독에서 Drag 에 따른 Layout 변화시 다음의 부분에서 Layout 변경 처리가 된다.
        /// </summary>
        void OnSplitterDragCompleted(object sender, System.Windows.Controls.Primitives.DragCompletedEventArgs e)
        {
            ...
            if (Orientation == System.Windows.Controls.Orientation.Horizontal)
            {
                if (prevChildModel.DockWidth.IsStar || prevChildModel.DockWidth.IsAuto)
                {
                ...
                if (nextChildModel.DockWidth.IsStar || nextChildModel.DockWidth.IsAuto)
                {
            ...
            else
            {
                ...
                if (nextChildModel.DockHeight.IsStar || nextChildModel.DockHeight.IsAuto)
                {
