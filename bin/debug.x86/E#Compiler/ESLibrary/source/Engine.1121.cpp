...
//===========================================================
//PropertyInstance 구현 
void(*ENG_CAPI_PropertyInstance_SetName)(eng_obj_ptr obj, const char *name) = NULL;
string(*ENG_CAPI_PropertyInstance_GetName)(eng_obj_ptr obj) = NULL;

void(*ENG_CAPI_PropertyInstance_SetLocked)(eng_obj_ptr obj, int locked) = NULL;
int(*ENG_CAPI_PropertyInstance_GetLocked)(eng_obj_ptr obj) = NULL;

void(*ENG_CAPI_PropertyInstance_SetExpanded)(eng_obj_ptr obj, int expanded) = NULL;
int(*ENG_CAPI_PropertyInstance_GetExpanded)(eng_obj_ptr obj) = NULL;

void(*ENG_CAPI_PropertyInstance_SetSelected)(eng_obj_ptr obj, int selected) = NULL;
int(*ENG_CAPI_PropertyInstance_GetSelected)(eng_obj_ptr obj) = NULL;
